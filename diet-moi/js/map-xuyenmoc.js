(function ($) {
    ...
    function mainMap() {
	    ...
	    //  Map Infoboxes ------------------
        var locations = [
            [locationData('https://br.kiemsoatmoiphuongnam.blog/br/xuyen-moc/diet-con-trung-xuyen-moc-casino-ho-tram-phuoc-thuan.html', 'https://br.kiemsoatmoiphuongnam.blog/image/600-400/map-casino-xuyen-moc.jpg', 'Sòng bài Xuyên Mộc', "Phước Thuận Xuyên Mộc, VN", 'gym-cat', "5", "5", "Xuyên Mộc"  ), 10.4875293, 107.4527643, 0 , 'https://br.kiemsoatmoiphuongnam.blog/image/600-400/map-casino-xuyen-moc.jpg'],
        ];
	    //   Map Infoboxes end ------------------
        var map = new google.maps.Map(document.getElementById('map-main'), {
            zoom: 12,
            scrollwheel: false,
            center: new google.maps.LatLng(10.5288629, 107.3979308),
